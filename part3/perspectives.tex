...
%The RSS perspective is commonly used to give a quick overview or introduction to a news article, and serves well as a link to the full article as the RSS feed includes the URL pointing to the web page where the full article is hosted. When the creator of the application does not have the rights to present the full article perspective because it would cause a copyright infringement, the web perspective can be used. 
